...
-- SeedData
insert into Referral (id, createdAt, updatedAt, email, phone, givenName, surName) values (1, datetime('now'), datetime('now'), 'testing@company.com.au', '0456123123', 'John', 'Doe');
